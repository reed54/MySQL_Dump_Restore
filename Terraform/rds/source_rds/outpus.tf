...
output "private_subnets" {
  ...
  value       = [aws_subnet.subnet-Matrix--Private-A.id, aws_subnet.subnet-Matrix--Private-C.id, aws_subnet.subnet-Matrix--Private-C.id]
}

output "public_subnets" {
  description = "List of public subnets."
  value       = [aws_subnet.subnet-Matrix--Public-A.id, aws_subnet.subnet-Matrix--Public-C.id, aws_subnet.subnet-Matrix--Public-C.id]
}
